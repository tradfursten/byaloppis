defmodule ByaloppisWeb.EventLiveTest do
  use ByaloppisWeb.ConnCase

  import Phoenix.LiveViewTest
  import Byaloppis.FleamarketFixtures

  @create_attrs %{date: "2023-02-19T20:46:00", description: "some description", name: "some name"}
  @update_attrs %{date: "2023-02-20T20:46:00", description: "some updated description", name: "some updated name"}
